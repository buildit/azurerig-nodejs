...
const askQuestions = async () => {
  ...
  const { TENANT_ID, RESOURCE_GROUP_NAME, LOCATION, DEVOPS_USERNAME, DEVOPS_PAT, DEVOPS_PROJ, GITHUB_PAT, SUBSCRIPTION_ID, SLACK_HOOK_URL } = answers;
  ...
  return new RigParameters(
    ...
    new AzDevOps(DEVOPS_USERNAME, DEVOPS_PAT, "BuilditAzureSandbox", DEVOPS_PROJ, SLACK_HOOK_URL),
